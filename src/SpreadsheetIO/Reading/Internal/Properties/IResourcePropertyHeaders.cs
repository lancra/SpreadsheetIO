...
namespace LanceC.SpreadsheetIO.Reading.Internal.Properties
{
    ...
    internal interface IResourcePropertyHeaders<TResource>
        where TResource : class
    {
        ...
        void Add(PropertyMap<TResource> map, uint columnNumber);
        ...
        bool ContainsMap(PropertyMap<TResource> map);
        ...
        PropertyMap<TResource> GetMap(uint columnNumber);
        ...
        bool TryGetMap(uint columnNumber, out PropertyMap<TResource>? map);
    }
}
